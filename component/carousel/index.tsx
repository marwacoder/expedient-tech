...
const bodyCard: Array<bodyDetails> = [
  {
    heading: 'Why us',
    subhead:
      'We are a diversified group of minds that are dedicated to resolving all of your technological business challenges.',
    img: '/logos/v1.png',
  },
  {
    heading: 'What we do',
    subhead:
      'Our service offerings range from consultancy to software development / customization and General Branding.',
    img: '/logos/v2.png',
  },
];
            ...
            <Box my={2}>
              <Item key={index} elevation={0}>
                <Box>
                  ...
                  <Box height="213px" display="block" bgcolor={'#0D4F6A14'}>
                    <Box
                    ...
                    <Typography
                      ...
                      height={'72px'}
                      fontSize={
                        xs ? '14px' : sm ? '15px' : md ? '15.9px' : '20px'
                      }
                    >
                      {items.subhead}
                    </Typography>
          ...
          <Grid container spacing={2} key={index}>
            ...
            <Grid item xs={12} sm={6}>
              <Box mt={2}>
                <Image
                  src={items.img}
                  width={xs ? 200 : sm ? 300 : md ? 300 : 400}
                  height={xs ? 200 : sm ? 300 : md ? 300 : 400}
                  alt="first"
                />
              </Box>
            </Grid>
